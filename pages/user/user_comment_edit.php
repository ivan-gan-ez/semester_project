...
//get comments
$sql = "SELECT * FROM userpage_comments WHERE up_comment_id = :id";
...
if ( !isAdmin() && $_SESSION["user"]["user_id"] != $comment['commenter_id'] ){
  header("Location: /");
  exit;
};

$id = $comment["up_comment_id"];
$userpage = $comment["userpage_id"];
    ...
    <div class="hero">
      <div class="mask p-5">
        ...
        <div class="card p-4">
          ...
          <form method="POST" action="/auth/user/comment/edit">
            ...
            <div class="pt-4 text-center">
              <a class="link-success text-decoration-none" href="/userpage?id=<?=$userpage?>">Go back</a>
            </div>
          </form>
        </div>
      </div>
